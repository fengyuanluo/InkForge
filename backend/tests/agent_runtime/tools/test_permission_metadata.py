...
def test_runtime_tool_permissions_match_registered_user_tools() -> None:
    ...
    assert get_default_agent_tool_permissions() == [
        ...
        {"tool_name": "discover_novel_rankings", "mode": "allow"},
        ...
        {"tool_name": "list_ranked_novels", "mode": "allow"},
        ...
        {"tool_name": "read_novel_opening", "mode": "allow"},
...
def test_runtime_tool_permission_helpers_use_tool_names() -> None:
    ...
    assert get_default_tool_permission_mode("discover_novel_rankings") == "allow"
    assert get_default_tool_permission_mode("list_ranked_novels") == "allow"
    assert get_default_tool_permission_mode("read_novel_opening") == "allow"
